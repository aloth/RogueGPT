...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22225536.svg)](https://doi.org/10.5281/zenodo.22225536)
...
|---|---|---|---|---|
| 1.2.0 | [`10.5281/zenodo.22225536`](https://doi.org/10.5281/zenodo.22225536) | 3,278 | 23 Mar 2026 | Current |
| 1.1.0 | [`10.5281/zenodo.21904524`](https://doi.org/10.5281/zenodo.21904524) | 3,278 | 23 Mar 2026 | Superseded |
...
1. **Stimulus generation (RogueGPT):** Fragments are produced with explicit control over model, style, language, format, and seed phrase. The model identifier, the full prompt and, for batch generation, the sampling parameters are persisted alongside the content. Fragments created through the web interface record model and prompt but not sampling settings, since that path uses provider defaults.
...
<details>
<summary><strong>Mapping to agent-based simulation requirements</strong> (how RogueGPT features map to recent ABS &amp; detection literature)</summary>

| Simulation Requirement | Enabling Feature | Reference |
|:---|:---|:---|
...
- **Misuse potential:** the generation component can produce misinformation-like content; see the [Disclaimer](#disclaimer) and intended research-only use.
...
| Use the dataset | [Request access on Zenodo](https://doi.org/10.5281/zenodo.18703137) (current version: [`22225536`](https://doi.org/10.5281/zenodo.22225536)) |
...
- **Can Humans Tell? A Dual-Axis Study of Human Perception of LLM-Generated News** (WebSci Companion '26). Reports human perception findings from RogueGPT-generated stimuli. [doi:10.1145/3795513.3807431](https://doi.org/10.1145/3795513.3807431)
...
- **Eroding the Truth-Default: A Causal Analysis of Human Susceptibility to Foundation Model Hallucinations and Disinformation in the Wild** (WWW '26 Companion). Uses this corpus as the stimulus set. [doi:10.1145/3774905.3795832](https://doi.org/10.1145/3774905.3795832)
- **Interrupting the Chain: Human Perception of AI-Generated Disinformation Through a Kill Chain Lens** (INFORMATIK 2026, LNI). [arXiv:2608.21389](https://arxiv.org/abs/2608.21389)
...
| [provenance-linkage](https://github.com/aloth/provenance-linkage) | Reproducibility bundle for a benchmark audit that uses this corpus as its in-domain material |
